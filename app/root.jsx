      ...
      <body>
        <Container fluid>
          <div styles="padding: 10px">
            <h1>Oops! Sorry, there's a major error!</h1>
            <p>{error.message}</p>
            <p>If need be, please press the refresh button in your browser after pressing on the back button down below.</p>
...
export function CatchBoundary() {
  ...
  return (
    <html lang="en">
      ...
      <body class="rootErrorCatchBoundary">
        <div class="permission_denied">
          <div class="denied__wrapper">
            <h1>Error {caught.status} {caught.statusText}</h1>
            <a href="https://quizment.herokuapp.com/">
              ...
              <svg id="planet" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <text x="40" y="200" fill="white">Go Home</text>
